...
export class DeployDB1679300744543 implements MigrationInterface {
	name = 'DeployDB1679300744543';
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`CREATE TABLE "usr"."user_shops_shop" (
				"shopId" integer NOT NULL, 
				"userId" integer NOT NULL, 
				CONSTRAINT "PK_1608f9e08ddc57a7bd1d63ffa4b" PRIMARY KEY ("shopId", "userId")
			)`
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE TABLE "commerce"."shop_analytics_user" (
				"userId" integer NOT NULL, 
				"shopId" integer NOT NULL, 
				CONSTRAINT "PK_e255b66cd89d3ab50a246ffeabf" PRIMARY KEY ("userId", "shopId")
			)`
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			...
			ADD CONSTRAINT "FK_801741ae213da67afe2f556d207" FOREIGN KEY ("user_id") 
			REFERENCES "usr"."user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
		);
		await queryRunner.query(
			`ALTER TABLE "usr"."user" 
			ADD CONSTRAINT "FK_b925754780ce53c20179d7204f9" FOREIGN KEY ("manager_id") 
			REFERENCES "usr"."user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
		);
		await queryRunner.query(
			`ALTER TABLE "commerce"."report" ADD CONSTRAINT "FK_5372ae61dfe258363ca876f17ac" FOREIGN KEY ("data_scientist_id") 
			REFERENCES "usr"."user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
		);
		await queryRunner.query(
			`ALTER TABLE "commerce"."report" ADD CONSTRAINT "FK_6b1a9a6f606dc82e2e6a39aaf33" FOREIGN KEY ("shop_id") 
			REFERENCES "commerce"."shop"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
		);
		await queryRunner.query(
			`ALTER TABLE "usr"."user_shops_shop" ADD CONSTRAINT "FK_b83248581d72cf5e9fbc9b006fe" FOREIGN KEY ("shopId") 
			REFERENCES "commerce"."shop"("id") ON DELETE CASCADE ON UPDATE CASCADE`
		);
		await queryRunner.query(
			`ALTER TABLE "usr"."user_shops_shop" ADD CONSTRAINT "FK_f0a70bdfa77eab06eaa824b2a59" FOREIGN KEY ("userId") 
			REFERENCES "usr"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
		);
		await queryRunner.query(
			`ALTER TABLE "commerce"."shop_analytics_user" ADD CONSTRAINT "FK_9897547de677a8e5b198c3faeb6" FOREIGN KEY ("userId") 
			REFERENCES "usr"."user"("id") ON DELETE CASCADE ON UPDATE CASCADE`
		);
		await queryRunner.query(
			`ALTER TABLE "commerce"."shop_analytics_user" ADD CONSTRAINT "FK_e79607aeb8308f4f9c710d6176c" FOREIGN KEY ("shopId") 
			REFERENCES "commerce"."shop"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
		);
		...
		await queryRunner.query(
			`INSERT INTO commerce.shop ("name", uuid, user_id) VALUES('Ozon', '${uuid()}', 3);`
		);

		await queryRunner.query(
			'INSERT INTO commerce.shop_analytics_user ("userId", "shopId") VALUES(7, 1);'
		);

		await queryRunner.query(
			'INSERT INTO usr.user_shops_shop ("shopId", "userId") VALUES(1, 7);'
		);
	}
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			'ALTER TABLE "commerce"."report" DROP CONSTRAINT "FK_6b1a9a6f606dc82e2e6a39aaf33"'
		);
		await queryRunner.query(
			'ALTER TABLE "commerce"."report" DROP CONSTRAINT "FK_5372ae61dfe258363ca876f17ac"'
		);
		await queryRunner.query(
		...
		await queryRunner.query('DROP TABLE "commerce"."report"');
